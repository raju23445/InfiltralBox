...
mkdir Tools
clear 
figlet -c "InfiltralBox : Hacking Tool"
echo -e '\033[31;40;1m 
                        
Coded by Rajarshi Dubey
github: https://github.com/raju23445
\033[33;4mVersion:\033[0m 3            \033[33;4mCTRL+C:\033[0m exit          

\e[37m[1]\e[36m Request & Update              \e[37m[2]\e[36m Phishing Tool				
...
echo -e "\033[47;31;5m Installing update & requirments...\033[0m"
sleep 5
pkg install git -y
...
apt upgrade -y
clear
echo -e "\033[47;3;35m Update...\033[0m"
sleep 3
bash tga.sh

elif [[ $islem == 2 || $islem == 02 ]]; then
clear
echo -e "\033[47;3;35m Installing update & requirments...\033[0m"
sleep 3
cd Tools
...
echo -e "\033[47;3;35m Removing downloaded program...\033[0m"
sleep 3 
rm -rf Tools
...
python3 n-anom.py
	...
	clear
        echo -e '\033[36;40;1m you enter worng code'	
	sleep 1
	clear 
	bash tga.sh
fi
